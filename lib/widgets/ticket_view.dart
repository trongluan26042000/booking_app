              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      SizedBox(
                        width: AppLayout.getWidth(100),child: Text(ticket['from']['code'],style: Styles.headLineStyle4.copyWith(color: Colors.white),),
                      ),
                      Text(ticket['flying_time'],style: Styles.headLineStyle3.copyWith(color:Colors.white),),
                      SizedBox(
                        width: AppLayout.getWidth(100),child: Text(ticket['to']['code'],textAlign: TextAlign.end,style: Styles.headLineStyle3.copyWith(color: Colors.white),),
                      ),
                    ],
                  ),
                ],
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Text(ticket['flying_time'],style: Styles.headLineStyle3.copyWith(color: Colors.white),),
                          const Gap(5),
                          Text('NGAY', style: Styles.headLineStyle4.copyWith(color: Colors.white),),
                        ],
                      ),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          ...
                          const Gap(5),
                          Text('Cất cánh', style: Styles.headLineStyle4.copyWith(color: Colors.white),),
                        ],
                      ),
                      Column(
                        ...
                        children: [
                          ...
                          const Gap(5),
                          Text('GHE', style: Styles.headLineStyle4.copyWith(color: Colors.white),),
                        ],
                      ),
                    ],
                  ),
